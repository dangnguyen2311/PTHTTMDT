...
public class OrderController {
    ...
    public ResponseEntity<?> orderDetail(HttpSession session, @PathVariable("orderId") String orderId) {
        ...
        System.out.println("Order: "+order.getOrderId() + " = id = " + orderId +", status: " + order.getStatus() + ",nums = " + productInOrderService.getProductInOrderByOrderId(orderId).size());
        ...
        System.out.println("ProductInOrder: " + productInOrderDaos);
