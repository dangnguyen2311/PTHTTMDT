...
const UserDetail = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.put("/api/v1/users/profile"); // sửa lại đúng endpoint backend
                                    ...
                                    <div className="card">
                                        <div className="card-body d-flex flex-column align-items-center text-center">
                                            ...
                                            <div className="mt-3">
                                                ...
                                                <p className="text-muted font-size-sm">Address: {user.userAddress}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div className="card-body">
                                            <form onSubmit={handleSubmit}>
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-sm-6">
                                                        <p className="form-control-plaintext">{user.userEmail}</p>
                                                    </div>
                                                </div>
                                                <hr/>
