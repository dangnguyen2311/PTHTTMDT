                                ...
                                <table className="table">
                                    ...
                                    {orders.map((order, index) => (
                                        <tr key={index}>
                                            ...
                                            <td>
                                                <p
                                                    className={`genric-btn circle medium px-2 py-1 m-0 ${order.status === 'returned' ? 'primary' : 'success'}`}
                                                    style={{minWidth: '80px', textAlign: 'center'}}
                                                >
                                                    {order.status !== 'returned' && order.status !== '' ? 'returned' : 'paid'}
                                                </p>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <Link
                                                    className="genric-btn medium danger px-2 py-1 m-2 text-center d-inline-block"
